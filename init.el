...
(custom-set-variables
 ...
 '(package-selected-packages
   '(eglot-jl enh-ruby-mode robe zenity-color-picker company-racer racer sublime-themes company-go company-fuzzy dumb-jump treemacs ivy projectile switch-window smex go-mode rust-mode scala-mode flycheck-rust switch-window- ace-window neotree speedbar-git-respect company-c-headers company flycheck))
