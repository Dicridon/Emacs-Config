...
(custom-set-faces
 ...
 '(company-scrollbar-bg ((t (:background "#4a8a4a8a4a8a"))))
 '(company-scrollbar-fg ((t (:background "#3dbd3dbd3dbd"))))
 '(company-tooltip ((t (:inherit default :background "#3dbd3dbd3dbd"))))
 '(company-tooltip-annotation ((t (:inherit company-tooltip :foreground "#FF9108"))))
 '(company-tooltip-common ((t (:inherit font-lock-constant-face))))
 '(company-tooltip-selection ((t (:background "#642364236423")))))
