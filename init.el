...
(custom-set-faces
 ...
 '(company-tooltip ((t (:inherit default :background "#58d858d858d8"))))
 '(company-tooltip-annotation ((t (:inherit company-tooltip :foreground "#FF9108"))))
 '(company-tooltip-common ((t (:inherit font-lock-constant-face))))
 '(company-tooltip-scrollbar-thumb ((t (:background "#58d858d858d8"))))
 '(company-tooltip-scrollbar-track ((t (:background "#65a565a565a5"))))
 '(company-tooltip-selection ((t (:background "#7f3e7f3e7f3e")))))
