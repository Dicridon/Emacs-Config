...
(custom-set-variables
 ...
 '(package-selected-packages
   '(eglot-jl enh-ruby-mode robe zenity-color-picker sublime-themes company-fuzzy dumb-jump treemacs ivy projectile switch-window smex go-mode rust-mode scala-mode flycheck-rust switch-window- ace-window neotree speedbar-git-respect company-c-headers company flycheck))
...
(custom-set-faces
 ...
 '(company-scrollbar-bg ((t (:background "#266626662666"))))
 '(company-scrollbar-fg ((t (:background "#199919991999"))))
