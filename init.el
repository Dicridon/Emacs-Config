...
(custom-set-faces
 ...
 '(company-tooltip ((t (:inherit default :background "#f6caed96dd7a"))))
 '(company-tooltip-annotation ((t (:inherit company-tooltip :foreground "#FF9108"))))
 '(company-tooltip-common ((t (:inherit font-lock-constant-face))))
 '(company-tooltip-scrollbar-thumb ((t (:background "#cd489a9141d2"))))
 '(company-tooltip-scrollbar-track ((t (:background "#ec6ad8d5b690"))))
 '(company-tooltip-selection ((t (:background "#e209c4148fa6")))))
